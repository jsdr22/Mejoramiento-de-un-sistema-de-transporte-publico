...
#color='#007BA7'
#color='#87CEEB'
plt.hist(data, bins=20, edgecolor='black', color='#87CEEB', alpha=0.7)  # Use '#87CEEB' for sky blue

# Add a vertical line for the mean value
plt.axvline(mean_value, color='red', linestyle='dashed', linewidth=2, label='Mean')

# Add labels and title
plt.xlabel('probe request/2min', fontsize=12)
plt.ylabel('Frecuencia', fontsize=12)
plt.title('Ejemplo de histograma paquetes filtrados', fontsize=14)
